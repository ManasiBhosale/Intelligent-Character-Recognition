...
def cut_image_into_rows(image_path, line_coords):
...
if __name__ == "__main__":
    ...
    #print("image_path py:",image_path)
    rows = cut_image_into_rows(image_path, line_coords)
    #print(line_coords)
...
def cut_image_into_rows(image_path, line_coords, box_coords):
    ...
    for idx, coords in enumerate(line_coords):
        ...
        line_image = image.crop((0, start, image.width, end))
       
        for (_, _, c_start, c_end) in box_coords[idx]:
