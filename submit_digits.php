...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Process the updated digits as needed
    // For example, save them to a database or perform further actions

    echo "Updated digits received:";
    echo "<pre>";
    print_r($boxes);
    echo "</pre>";
} else {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['output_format'])) {
    ...
    echo "Output file created: <a href='$output' download>$output</a>";
} else {
    $input_image = $_POST['input_image'];
    $boxes = $_POST['boxes'];
?>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['output_format'])) {
    ...
    // Displaying the result and the form again
    echo "<p>Output file created: <a href='$output' download>$output</a></p>";
    display_form($input_image, $_POST['boxes'], $output_format);
} else {
    $input_image = isset($_POST['input_image']) ? $_POST['input_image'] : '';
    $boxes = isset($_POST['boxes']) ? $_POST['boxes'] : '';
    $output_format = '';
    display_form($input_image, $boxes, $output_format);
}

function display_form($input_image, $boxes, $selected_format) {
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
